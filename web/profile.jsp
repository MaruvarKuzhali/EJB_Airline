<%-- 
    Document   : profile
    Created on : 5 May, 2021, 10:32:46 AM
                    ...
                    <div class="row m-l-0 m-r-0">
                        <div class="col-sm-4 bg-c-lite-green user-profile">
                            <div class="card-block text-center text-white">
                                ...
                                <h6 class="f-w-600"><%= n%> <%= m%></h6>
                                <p>Registered Date <%= rs.getDate(6)%></p> 
                            </div>
                        </div>
                        <div class="col-sm-8">
                            <div class="card-block">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <h6 class="text-muted f-w-400"><%= n%> <%= m%></h6>
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <h6 class="text-muted f-w-400"><%= rs.getString(4)%></h6>
                                    </div>
                                    <div class="col-sm-6">
                                        <p class="m-b-10 f-w-600">Password</p>
                                        <h6 class="text-muted f-w-400"><%= rs.getString(5)%></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
